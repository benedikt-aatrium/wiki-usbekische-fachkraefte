# Ablauf Anerkennung ausländischer Berufsabschlüsse: IHK FOSA vs. HWK
...
## Ablauf bei der IHK FOSA

Die IHK FOSA (Foreign Skills Approval) ist die zentrale Anlaufstelle für die Anerkennung ausländischer Abschlüsse in **Industrie-, Handels- und Dienstleistungsberufen**. Sie prüft, ob ein ausländischer Abschluss einem deutschen Ausbildungsberuf gleichwertig ist.

### Schritt 1: Antragsberechtigung prüfen

- Der Kandidat hat einen ausländischen Berufsabschluss.
- Der Abschluss soll einem deutschen Ausbildungsberuf zugeordnet werden.
- Der Kandidat will in Deutschland in diesem Beruf arbeiten.
...
- Die IHK FOSA prüft den ausländischen Abschluss nach formellen und inhaltlichen Kriterien.
- Vergleich mit dem deutschen Ausbildungsberuf.
- Keine persönliche Prüfung des Kandidaten in der Regel.
...
| Ergebnis | Bedeutung |
|----------|-----------|
| **Gleichwertig** | Abschluss wird als gleichwertig anerkannt. Arbeitserlaubnis ohne weitere Bedingungen. |
| **Teilweise gleichwertig** | Es fehlen geringe Qualifikationsunterschiede. Anpassungsmaßnahme oder Ausgleichsbescheinigung nötig. |
| **Nicht gleichwertig** | Wesentliche Unterschiede. Anerkennung nur nach Prüfung oder weiterer Qualifikation. |
...
## Ablauf bei der Handwerkskammer (HWK)

Handwerkskammern sind in Deutschland regional organisiert. Die **zuständige HWK** ist die Kammer, in deren Bezirk der Arbeitnehmer später arbeitet. Für Max Bögl ist das z. B. die HWK für die Oberpfalz bei Einsatz in Sengenthal/Neumarkt.

### Schritt 1: Antragsberechtigung prüfen

- Kandidat hat eine handwerkliche Ausbildung (z. B. Maurer, Zimmerer, Metallbauer).
- Die Ausbildung soll einem deutschen Handwerksberuf zugeordnet werden.
- Kandidat will im deutschen Handwerk arbeiten.

### Schritt 2: Zuständige HWK ermitteln

- HWK nach dem **Einsatzort** des Arbeitnehmers wählen.
- Beispiel Max Bögl:
  - Sengenthal/Neumarkt → HWK für die Oberpfalz
  - Magdeburg → HWK Magdeburg
  - Berlin → HWK Berlin

### Schritt 3: Vorgespräch / Beratung

- Viele HWK bieten eine kostenlose Beratung vor Antragstellung an.
- Empfohlen: Vorab per E-Mail oder Telefon klären, welche Unterlagen benötigt werden.
- Wichtig: Ausbildungsinhalt und deutschen Zielberuf abgleichen.

### Schritt 4: Antrag stellen

- Antragsformular der zuständigen HWK ausfüllen.
- Dokumente per Post, E-Mail oder Online-Portal einreichen.
- Gebühr entrichten (ca. 100–500 € je nach Kammer).

### Schritt 5: Erforderliche Dokumente
...
- Prüfung meist in Deutsch.
- Bestehen aus theoretischem und praktischem Teil.
- Bei Erfolg: Anerkennung als deutscher Handwerksberuf.
...
- [ ] Deutschen Zielberuf klar definiert
- [ ] Zuständige Stelle ermittelt (IHK FOSA oder HWK)
- [ ] Antragsformular vollständig ausgefüllt
- [ ] Passkopie vorhanden
- [ ] Ausbildungsnachweise mit Apostille und Übersetzung
- [ ] Arbeitsnachweise (Arbeitsbuch / Zeugnisse) vorhanden
- [ ] Gebühr entrichtet
- [ ] ZAV-Verfahren / Visum nach Anerkennung geplant

### Zusätzlich für HWK

- [ ] Zuständige HWK nach Einsatzort kontaktiert
- [ ] Ggf. Prüfungstermin in Erfahrung gebracht
- [ ] Prüfungsvorbereitung in Deutsch geplant

### Zusätzlich für IHK FOSA
