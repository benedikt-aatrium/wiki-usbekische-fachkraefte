...
| Eintrag | Bedeutung | Übersetzung |
|---------|-----------|-------------|
| **Qabul qilindi** | Eingestellt als | Eingestellt als |
| **Ishdan bo'shatildi** | Entlassen aus | Entlassen aus |
| **Ish joyi** | Arbeitsplatz | Arbeitsplatz |
| **Lavozimi** | Position | Position |
| **Ish haqi** | Gehalt | Gehalt |
| **Mehnat staji** | Berufserfahrung | Berufserfahrung |

### Stempel und Unterschriften

Das Arbeitsbuch enthält **Stempel** und **Unterschriften** des Arbeitgebers:

| Stempel | Bedeutung |
|---------|-----------|
| **Muhr** | Siegel des Unternehmens |
| **Imzo** | Unterschrift des Arbeitgebers |
| **Sana** | Datum |

!!! warning "Wichtig"
    Das Arbeitsbuch muss **vollständig** sein. Fehlende Seiten oder unleserliche Stempel können zu Problemen bei der Anerkennung führen.

### Was tun, wenn das Arbeitsbuch fehlt?
...
Das **Diplom** ist der **Abschluss** einer Berufsausbildung oder eines Studiums in Usbekistan. Es entspricht dem deutschen Abschlusszeugnis.
...
|-----------|--------|-----------|
| **Titelseite** | Name, Foto, Diplomnummer | Identifikation |
| **Innenseite** | Institution, Fachrichtung, Abschlussjahr | Ausbildungsdetails |
| **Rückseite** | Noten und Fächer | Leistungsübersicht |
| **Stempel** | Siegel der Institution | Beglaubigung |

### Wichtige Angaben im Diplom

| Angabe | Bedeutung | Übersetzung |
|--------|-----------|-------------|
| **Diplom raqami** | Diplomnummer | Diplomnummer |
| **Ta'lim muassasasi** | Bildungseinrichtung | Bildungseinrichtung |
| **Mutaxassislik** | Fachrichtung | Fachrichtung |
...
Die **Ilova** (usbekisch: *Anlage*) ist eine **Anlage zum Diplom**, die die **Noten und Fächer** im Detail auflistet. Sie ist für die Anerkennung besonders wichtig.

### Aufbau der Ilova

| Abschnitt | Inhalt | Bedeutung |
|-----------|--------|-----------|
| **Titelseite** | Name, Diplomnummer | Identifikation |
| **Fächerliste** | Alle Fächer mit Noten | Leistungsübersicht |
| **Praxisnachweise** | Praktika und Projekte | Praxiserfahrung |
| **Abschlussarbeit** | Thema der Abschlussarbeit | Spezialisierung |

### Warum ist die Ilova wichtig?

Die Ilova ist wichtig für die **Gleichwertigkeitsprüfung**, weil sie zeigt:
- **Welche Fächer** unterrichtet wurden
- **Wie viele Stunden** pro Fach
- **Welche Praxiserfahrung** gesammelt wurde

!!! tip "Tipp"
    Die **Ilova** ist oft **wichtiger als das Diplom selbst**, weil sie die Details der Ausbildung zeigt. Ohne Ilova kann die Gleichwertigkeitsprüfung schwierig sein.

---

## Svidetelstvo (sowjetische Abschlüsse)

### Was ist das Svidetelstvo?

Das **Svidetelstvo** (russisch: *Свидетельство*) ist ein **sowjetischer Abschluss**, der vor 1991 ausgestellt wurde. Es entspricht dem deutschen Abschlusszeugnis.
...
| Angabe | Bedeutung | Übersetzung |
|--------|-----------|-------------|
| **Maktab nomi** | Schulname | Schulname |
| **Bitirgan yili** | Abschlussjahr | Abschlussjahr |
| **O'rtacha baho** | Durchschnittsnote | Durchschnittsnote |
| **Fanlar ro'yxati** | Fächerliste | Fächerliste |

---

## Übersicht: Dokumente und ihre Bedeutung
