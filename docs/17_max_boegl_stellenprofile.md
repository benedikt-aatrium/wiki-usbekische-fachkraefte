# 17 Max Bögl Stellenprofile – Anerkennung und Zuständigkeit
...
4. **Ist der Abschluss in Anabin verzeichnet** (nur bei Studium)?

!!! info "Kernregel"
    Die zuständige Kammer richtet sich nach dem **Einsatzort des Arbeitnehmers**, nicht nach dem Unternehmenssitz. Die Rechtsgrundlage für die Anerkennung von Berufsabschlüssen ist das **Berufsbildungsgesetz (BBiG)** und die **Handwerksordnung (HwO)**.

---

## Rechtsgrundlagen für die Anerkennung

| Gesetz | Paragraph | Inhalt | Relevanz für Max Bögl |
|--------|-----------|--------|----------------------|
| **AufenthG** | § 18 | Grundsatz der Fachkräfteeinwanderung; allgemeine Bestimmungen | Definiert, was eine Fachkraft ist und welche Voraussetzungen für das Visum gelten |
| **AufenthG** | § 18a | Fachkräfte mit Berufsausbildung | Für Facharbeiter mit anerkannter Ausbildung |
| **AufenthG** | § 18b | Fachkräfte mit akademischer Ausbildung | Für Akademiker mit anerkanntem Studium |
| **BBiG** | § 50 | Gleichstellung von Prüfungszeugnissen | Rechtsgrundlage für die Gleichwertigkeitsprüfung ausländischer Abschlüsse |
| **HwO** | § 41b | Feststellung der individuellen beruflichen Handlungsfähigkeit | Verfahren für Handwerksberufe (Maurer, Zimmerer, etc.) |
| **HwO** | § 123a | Übergangsvorschriften | § 41b gilt seit 1. Januar 2025 |
...
||---------|-----|----------|
|| Rechtsgrundlage | Handwerksordnung (HwO) | Berufsbildungsgesetz (BBiG) |
...
|| Verfahren | Feststellungsverfahren nach § 41b HwO | Gleichwertigkeitsprüfung nach § 50 BBiG |
...
|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50311082-0002-B` |
...
|| **Anabin-Relevanz** | Nur bei Studium (`bakalavr (avtomobil yo'llari, ...)` A4) |
|| **BQ-Portal-Profil** | `Bautechniker/in` (Quruvchi-texnik), seit 2021 |

### 2. Elektroniker für Geräte und Systeme

|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50438392-0002-A` |
...
|| **Anabin-Relevanz** | Nur bei Studium (`bakalavr (avtomobilsozlik va traktorsozlik)` A4, bedingt passend) |
|| **BQ-Portal-Profil** | Kein direktes Profil; nächster verwandter: `Autoschlosser` |

### 3. Elektroniker für Baustellenversorgung

|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50456029-0002-A` |
...
|| **Anabin-Relevanz** | Nur bei Studium (siehe Elektroniker für Geräte und Systeme) |
|| **BQ-Portal-Profil** | Kein direktes Profil |

### 4. Kranfahrer (Mobil-/Raupen-/Turmdrehkran)

|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50493401-0002-A` |
...
|| **Anabin-Relevanz** | Kein passender usbekischer Anabin-Eintrag |
|| **BQ-Portal-Profil** | Kein direktes Profil |
...
|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50455987-0002-A` |
|| **Standorte** | Bundesweit |
...
|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50472915-0002-A` |
|| **Standorte** | Bundesweit |
...
|| **Anabin-Relevanz** | Nur bei Studium (`bakalavr (suv xo'jaligi va melioratsiya)` A4) |
|| **BQ-Portal-Profil** | Kein direktes Profil |
...
|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50439123-0002-A` |
|| **Standorte** | Sengenthal, Neumarkt |
...
|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50484766-0002-A` |
|| **Standorte** | Sengenthal, Neumarkt |
...
|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50483273-0002-A` |
|| **Standorte** | Sengenthal, Neumarkt |
...
|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50444256-0002-A` |
|| **Standorte** | Sengenthal, Neumarkt |
...
|| **Anabin-Relevanz** | Kein passender usbekischer Anabin-Eintrag |
|| **BQ-Portal-Profil** | `Bautischler` / `Bautischler, Zimmerer (Parkettleger)` (1986–2001) |

### 11. Schlosser / Monteur im Stahlbau

|| Kategorie | Inhalt |
||-----------|--------|
|| **Referenzcode** | `DE-50489411-0002-A` |
|| **Standorte** | Bundesweit |
...
|| **Anabin-Relevanz** | Kein passender usbekischer Anabin-Eintrag |
|| **BQ-Portal-Profil** | `Autoschlosser (Qualifikationskategorie 3/4/6)` (1969–1985 / seit 1985) |
...
### Für HWK-Berufe (§ 41b HwO)

- Arbeitsbuch / Mehnat daftari (Arbeitsbescheinigung)
...
1. **Kandidatenprofil klären**
   - Welche Ausbildung hat der Kandidat? (Arbeitsbuch prüfen!)
...
2. **Deutschen Beruf zuordnen**
   ...
   - Anabin prüfen (nur bei Studium)

3. **Zuständige Kammer ermitteln**
   - HWK-Beruf: HWK am Einsatzort (§ 41b HwO)
   - IHK-Beruf: IHK FOSA (zentral, § 50 BBiG)

4. **Anerkennungsverfahren einleiten**
   - Dokumente sammeln und übersetzen lassen
   - Antrag bei der zuständigen Stelle
   - Feststellungsverfahren (HWK) oder Gleichwertigkeitsprüfung (IHK FOSA)

5. **ZAV-Zustimmung und Visum**
   - Nach Anerkennung oder bei Nachweis ausreichender Qualifikation: ZAV-Verfahren
   - Visum nach § 18a AufenthG (Fachkräfte mit Berufsausbildung) oder § 18b AufenthG (akademische Fachkräfte)
...
|| Anabin als Berufsanerkennung missverstehen | Anabin ist nur für Hochschulabschlüsse relevant, nicht für Facharbeiterausbildungen |
...
- **Anabin ist nur für 2 Positionen relevant** (bei Studium), für die anderen 9 Positionen ist die IHK FOSA/HWK der richtige Weg.
- Das **BQ-Portal** hat nur für 3 Positionen direkte usbekische Berufsprofile (Bautechniker, Bautischler, Autoschlosser).
...
- **Berufsbildungsgesetz (BBiG)**: § 50 (Gleichstellung von Prüfungszeugnissen)
- **Handwerksordnung (HwO)**: § 41b (Feststellung der individuellen beruflichen Handlungsfähigkeit), § 123a (Übergangsvorschriften)
